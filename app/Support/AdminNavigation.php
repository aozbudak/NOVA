...
final class AdminNavigation
{
    ...
    private const ROUTE_PERMISSIONS = [
        ...
        'admin.discounts.index' => 'discounts',
        'admin.discounts.store' => 'discounts',
        'admin.discounts.update' => 'discounts',
        'admin.discounts.toggle' => 'discounts',
        'admin.discounts.destroy' => 'discounts',
        ...
        'api.categories.destroy' => 'categories',
        'api.categories.header.store' => 'categories',
        'api.categories.header.destroy' => 'categories',
        'api.brands.index' => 'brands',
        'api.brands.store' => 'brands',
        'api.brands.update' => 'brands',
        'api.brands.destroy' => 'brands',
        'api.discounts.index' => 'discounts',
        'api.discounts.store' => 'discounts',
        'api.discounts.update' => 'discounts',
        'api.discounts.destroy' => 'discounts',
        ...
        $sections = [
            ...
            [
                ...
                'items' => [
                    ...
                    $this->item('discounts', 'discounts', 'admin.discounts.index', 'discounts'),

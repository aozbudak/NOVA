<div data-overlay="search" class="glass-strong fixed inset-0 z-50 hidden" role="dialog" aria-modal="true" aria-labelledby="search-title">
    <div class="mx-auto flex h-full max-w-3xl flex-col px-4 py-5 md:px-8 md:py-6">
        ...
        <form action="{{ route('search') }}" method="get" class="mt-6 border-b border-foreground pb-3">
        ...
        <div data-search-results class="mt-6 hidden"></div>
        <div data-search-trending class="mt-6">
